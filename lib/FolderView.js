  ...
  _createClass(FolderView, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        open ? _react2.default.createElement('i', { className: 'fa fa-folder-open', 'aria-hidden': 'true' }) : _react2.default.createElement('i', { className: 'fa fa-folder', 'aria-hidden': 'true' }),
        folderTemplate && folderTemplate({
          name: name,
          folderObj: folderObj,
